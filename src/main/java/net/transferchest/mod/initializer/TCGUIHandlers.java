...
public final class TCGUIHandlers
{
    ...
    {
        TRANSFER_CHEST_GUI_HANDLER = ScreenHandlerRegistry.registerExtended(TransferChestBlock.ID, (syncId, inventory, buf) -> new TransferChestGUIHandler(syncId, inventory, ScreenHandlerContext.create(inventory.player.world, buf.readBlockPos())));
    }
}
