...
public final class TCItems {
    ...
    public static void initialize() {
        TRANSFER_CHEST_ITEM = Registry.register(Registries.ITEM, TransferChestBlock.ID, new BlockItem(TCBlocks.TRANSFER_CHEST_BLOCK, new Item.Settings().registryKey(
                RegistryKey.of(RegistryKeys.ITEM, TransferChestBlock.ID))));
