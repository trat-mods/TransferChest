...
public final class TCEntities
{
    ...
    {
        TRANSFER_CHEST_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, TCLoader.MOD_ID + ":" + TransferChestBlock.ID.getPath(), BlockEntityType.Builder.create(TransferChestBlockEntity::new, TCBlocks.TRANSFER_CHEST_BLOCK).build(null));
    }
}
